  ...
  initDB() async {
    ...
    return await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        await db.execute(
            "CREATE TABLE IF NOT EXISTS document_nci(id INTEGER PRIMARY KEY, parent2_id INTEGER, name TEXT, date TEXT, number TEXT, description TEXT, file_name TEXT, file_data STRING, type INTEGER, is_new TEXT)");
      },
